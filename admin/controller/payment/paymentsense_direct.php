<?php 
class ControllerPaymentPaymentSensedirect extends Controller {
	private $error = array(); 
	...
	public function index() {
		...
		$data['action'] = $this->url->link('payment/paymentsense_direct', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('payment/paymentsense_direct.tpl', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'payment/paymentsense_direct')) 
		{
